...
<%
        ...
        while (rs.next()) {
            ...
            out.println("<td><input type='text' name=' ' value='" + status + "' readonly=readonly></td>");
             ...
             out.println("<td><select name='inge'><option value='iSop'>IngenieroSop1</option><option value='iSop2'>IngenieroSop2</option></select></td>");
            
            out.println("<td><input type='text' name='solu' value='" + sol + "' readonly=readonly></td>");
                
            out.println("<td><input type='submit' name='altaReporteEnProceso.jsp' value='Asignar Ing'></td>");
    ...
    %>
            <button class="ver-reportes" onclick="location.href='gManlista.jsp'" >Asignar reportes a un Gerente de Mantenimiento</button>
</BODY>
