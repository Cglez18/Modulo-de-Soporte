...
<%
        ...
        out.println("<th>Gerente asignado</th>");
        ...
        while (rs.next()) {
            ...
            out.println("<form action='altaReporteEnProcesoMan.jsp' method='post' name='subir2'>");
            out.println("<tr>");
            ...
            out.println("<td><select name='inge'><option value='gMan'>GerenteMantenimiento</option><option value='gMan2'>GerenteMantenimiento2</option></select></td>");
            
            out.println("<td><input type='text' name='solu' value='" + sol + "' readonly=readonly></td>");
            
            
                
            out.println("<td><input type='submit' name='altaReporteEnProcesoMan.jsp' value='Asignar gMant'></td>");
