...
<%! Statement stmt; %>
<%! ResultSet rs = null;%>
<%! String status = "En programacion finalizada"; %>
...
<%
        ...
        while (rs.next()) {
            ...
            out.println("<td><input type='submit' name='programacionFinalizada4.jsp' value='SUBIR'></td>");
            out.println("</tr>");
...
<footer><button class="salir" onclick="location.href='gMan2.html'" >Regresar</button></footer>
</HTML>