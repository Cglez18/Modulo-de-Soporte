...
<%
        ...
        while (rs.next()) {
            ...
            out.println("<form action='enProgramacion2.jsp' method='post' name='subir2' onsubmit='return validateForm()'>");
            out.println("<tr>");
            ...
            out.println("<td><input type='text' name=' ' value='" + status + "' readonly=readonly></td>");
                ...
                out.println("<td><input type='submit' name='enProgramacion2.jsp' value='SUBIR'></td>");
