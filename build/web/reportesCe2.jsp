...
<%
        ...
        while (rs.next()) {
            ...
            out.println("<form action='suburFAQSCerrado.jsp' method='post' name='subir2'>");
            out.println("<tr>");
...
<footer><button class="salir" onclick="location.href='editor.html'" >Regresar</button></footer>
</HTML>