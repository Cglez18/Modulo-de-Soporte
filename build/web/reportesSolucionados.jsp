...
<%
    out.println("<br>");
    out.println("<br>");
    out.println("<h1>Bienvenido Ingeniero de Soporte</h1>");
        ...
        while (rs.next()) {
            ...
            out.println("<td><input type='submit' name='reportesCerradosiSop.jsp' value='ENVIAR'></td>");
            out.println("</tr>");
...
<footer><button class="ver-reportes" onclick="location.href='solucionarReportesSop.jsp'" >SolucionarReportes</button></footer>
</HTML>