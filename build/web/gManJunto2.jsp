    ...
    <li><a href="gerSop.jsp" >Regresar</a></li>
      ...
      <%
        ...
        while (rs2.next()) { 
            ...
            out.println("<form action='gMan3.jsp' method='post' name='subir2'>");
            out.println("<tr>");
            ...
            out.println("<td><input type='submit' name='gMan3.jsp' value='ASIGNAR Ing'></td>");
       ...
       while (rs5.next()) {
            ...
            out.println("<form action='programacionFinalizada4.jsp' method='post' name='subir2'>");
            out.println("<tr>");
            out.println("<td><input type='text' name='idRe' value='" + idR2 + "' readonly=readonly></td>");
            ...
            out.println("<td><input type='text' name='solu' value='" + sol + "' readonly=readonly></td>");
             ...
             out.println("<td><input type='submit' name='programacionFinalizada4.jsp' value='ENVIAR GerSop'></td>");
