...
<%
        ...
        while (rs.next()) {
            ...
            out.println("<td><input type='text' name=' ' value='" + status + "', '" + status2 + "' readonly=readonly></td>");
...
<footer><button class="salir" onclick="location.href='reportesCe3.jsp'" >Regresar</button></footer>
</HTML>
</HTML>
